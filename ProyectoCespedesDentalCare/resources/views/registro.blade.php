...
<body class="bg-secondary">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group mt-4 mb-0"><a class="btn btn-secondary btn-block"
                                                href="{{ route('Login') }}">Crear Cuenta</a></div>
                                    </form>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="small"><a href="{{ route('Login') }}">¿Tienes una cuenta? Ir al login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="static/css/styles.cssjs/scripts.js"></script>
</body>
