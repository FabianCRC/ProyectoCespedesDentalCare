                        ...
                        <tr class="shadow-sm">
                            ...
                            <td><span class="d-block">
                                    @if ($registro->nombre_Paciente_nuevo == $registro->nombre_Paciente_viejo)
                                        No hubo cambio
                                    @else
                                        {{ $registro->nombre_Paciente_nuevo }} ->{{ $registro->nombre_Paciente_viejo }}
                                    @endif
                                </span></td>
                            <td><span class="d-block">
                                    @if ($registro->observaciones_Paciente_nuevo == $registro->observaciones_Paciente_viejo)
                                        No hubo cambio
                                    @else
                                        {{ $registro->observaciones_Paciente_nuevo }} ->{{ $registro->observaciones_Paciente_viejo }}
                                    @endif
                                </span></td>
                            <td><span class="d-block">
                                    @if ($registro->datos_Paciente_nuevo == $registro->datos_Paciente_viejo)
                                        No hubo cambio
                                    @else
                                        {{ $registro->datos_Paciente_nuevo }} ->{{ $registro->datos_Paciente_viejo }}
                                    @endif
                                </span></td>
                            <td><span class="d-block">
                            ...
                            <td><span class="d-block">
                                    @if ($registro->dentista_Paciente_nuevo == $registro->dentista_Paciente_viejo)
                                        No hubo cambio
                                    @else
                                        {{ $registro->dentista_Paciente_nuevo }} ->{{ $registro->dentista_Paciente_viejo }}
                                    @endif
                                </span></td>
                            <td><span class="d-block">
                                {{ $registro->usuario }}
